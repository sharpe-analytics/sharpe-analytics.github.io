...
- All content and feature panels work without JavaScript. JavaScript adds feature selection, interactive SVG product previews and the illustrative deposit slider. The previews use fictional local data and make no network requests. The contribution preview explicitly uses fixed illustrative returns, not the extension’s historical simulation engine.
