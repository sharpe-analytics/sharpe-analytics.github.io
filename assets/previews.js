...
(() => {
 ...
 function embed(host,tab,hero=false){
  ...
  const full=document.createElement('a');full.href=demoUrl(tab);full.target='_blank';full.rel='noopener';full.textContent='Open full-size demo';caption.append(full);shell.append(caption);host.append(shell);
